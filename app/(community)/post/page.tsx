    ...
    return (
        <article className="container relative max-w py-6 lg:py-10">
            ...
            <div>
                ...
                {detail?.magazine ? (
                    <div className="mt-4 flex space-x-4">
                        ...
                        >
                            <Image
                                src={NEXT_PUBLIC_BUCKET_URL + detail?.magazine.profileUrl}
            ...
            <div className="flex justify-center py-6 lg:py-10">
                <Link href="/post" className="inline-flex items-center justify-center text-sm font-medium text-slate-600 hover:text-slate-900">
                    <Icons.chevronLeft className="mr-2 h-4 w-4" />
                    See all posts
                </Link>
            </div>
